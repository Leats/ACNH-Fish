...
class App extends React.Component {
  ...
  componentDidMount() {
    const caughtFishStorage = localStorage.getItem("ACNHCaughtFish")
      ? localStorage.getItem("ACNHCaughtFish").split(",")
      : [];
  ...
  addFish(name) {
    ...
    if (this.state.caughtFish.includes(name)) {
      newFish = this.state.caughtFish.filter(function (v) {
        return v !== name;
      });
  ...
  render() {
    const fishList =
      this.state.hemisphere === "Northern Hemisphere"
        ? fish_northern
        : fish_southern;
    return (
      <div className="App">
        <header className="App-header">
          <span>
            <a href="https://twitter.com/LeatsHere">
        ...
        <div id="welcome-text">
          Hello! <br />
          On this site you can find out which fish you can still catch in Animal
          Crossing: New Horizons.
          <br />
          Just take a look at the options and then choose the fish you have
          already caught. You'll see the fish you still need to catch at the
          bottom :) <br />
          Don't worry! Your data gets saved between sessions!
          <br />
          All data is taken from the{" "}
          <a href="https://animalcrossing.fandom.com/wiki/Fish_(New_Horizons)">
            Animal Crossing Fandom Wikia
          </a>
          .
        </div>
        <div className="Options">
          <Options
            ...
            overwriteMonth={this.overwriteMonth}
